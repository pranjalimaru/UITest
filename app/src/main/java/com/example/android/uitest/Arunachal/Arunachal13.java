package com.example.android.uitest.Arunachal;
...
public class Arunachal13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Arunachal13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=245;
    ArrayList<String> colors = new ArrayList<>();
    List<String> choice;
    Button mSelect;
    TextView mItemSelected, displayText;
    String[] listItems, arunachalPradesh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arunachal13);
        ...
        arunachalPradesh= getResources().getStringArray(R.array.ArunachalPradeshDistricts);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Arunachal13.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<16;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(arunachalPradesh[i]);
                    displayText.append("\n");
                }
            }
        });
    ...
    private List<String[]> readCVSFromAssetFolder(){
        ...
        //String[] content = null;
        try {
            InputStream inputStream = getAssets().open("ArunachalPradesh.csv");
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Arunachal13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
