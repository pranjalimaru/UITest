...
public class India23 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = India23.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_india23);
        ...
        district.add("Uttarakhand");
        district.add("Haryana");
        district.add("NCT of Delhi");
        district.add("Rajasthan");
        district.add("Uttar Pradesh");
        district.add("Bihar");
        district.add("Sikkim");
        district.add("Arunachal Pradesh");
        district.add("Nagaland");
        district.add("Manipur");
        district.add("MizoramFront");
        district.add("Tripura");
        district.add("Meghalaya");
        district.add("Assam");
        district.add("West Bengal");
        district.add("Jharkhand");
        district.add("Odisha");
        district.add("Chattisgarh");
        district.add("Madhya Pradesh");
        district.add("Gujarat");
        district.add("Daman Diu");
        district.add("Dadra Nagar Haveli");
        district.add("Maharashtra");
        district.add("Andhra Pradesh");
        district.add("Karnataka");
        district.add("Goa");
        district.add("Lakshadweep");
        district.add("Kerala");
        district.add("Tamil Nadu");
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(India23.this);
