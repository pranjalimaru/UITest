package com.example.android.uitest.HimachalPradesh;
...
public class hp13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = hp13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=23;
    ArrayList<String> colors = new ArrayList<>();
    List<String> choice;
    Button mSelect;
    TextView mItemSelected, displayText;
    String[] listItems, hpDistricts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hp13);
        ...
        hpDistricts= getResources().getStringArray(R.array.HimachalPradesh);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(hp13.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<12;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(hpDistricts[i]);
                    displayText.append("\n");
                }
            }
        });
    ...
    private List<String[]> readCVSFromAssetFolder(){
        ...
        //String[] content = null;
        try {
            InputStream inputStream = getAssets().open("HimachalPradesh.csv");
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(hp13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
