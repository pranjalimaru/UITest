...
import com.example.android.uitest.UttarPradesh.up11;
import com.example.android.uitest.UttarPradesh.up12;
import com.example.android.uitest.UttarPradesh.up13;
import com.example.android.uitest.UttarPradesh.up21;
import com.example.android.uitest.UttarPradesh.up22;
import com.example.android.uitest.UttarPradesh.up23;
import com.example.android.uitest.UttarPradesh.up31;
import com.example.android.uitest.UttarPradesh.up32;
import com.example.android.uitest.UttarPradesh.up33;

public class UttarPradeshFront extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_uttar_pradesh_front);
        ...
        button11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UttarPradeshFront.this, up11.class);
        ...
        button12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UttarPradeshFront.this, up12.class);
                startActivity(intent);
        ...
        button13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UttarPradeshFront.this, up13.class);
                startActivity(intent);
        ...
        button21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UttarPradeshFront.this, up21.class);
                startActivity(intent);
        ...
        button22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UttarPradeshFront.this, up22.class);
                startActivity(intent);
        ...
        button23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UttarPradeshFront.this, up23.class);
                startActivity(intent);
        ...
        button31.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UttarPradeshFront.this, up31.class);
                startActivity(intent);
            }
        });
        ...
        button32.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UttarPradeshFront.this, up32.class);
                startActivity(intent);
            }
        });
        ...
        button33.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UttarPradeshFront.this, up33.class);
                startActivity(intent);
