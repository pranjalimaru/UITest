package com.example.android.uitest.AndamanNicobar;
...
public class AndamanNicobar13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = AndamanNicobar13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=638;
    ArrayList<String> colors = new ArrayList<>();
    List<String> choice;
    Button mSelect;
    TextView mItemSelected, displayText;
    String[] listItems, andamanDistricts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_andaman_nicobar13);
        ...
        andamanDistricts= getResources().getStringArray(R.array.AndamanNicobarDistricts);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(AndamanNicobar13.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<3;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(andamanDistricts[i]);
                    displayText.append("\n");
                }
            }
        });
    ...
    private List<String[]> readCVSFromAssetFolder(){
        ...
        //String[] content = null;
        try {
            InputStream inputStream = getAssets().open("AndamanNicobar.csv");
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(AndamanNicobar13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
