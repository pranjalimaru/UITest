...
public class Assam11 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Assam11.class.getSimpleName();
    ...
    String[] listItems, assamDistricts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assam11);
        ...
        assamDistricts = getResources().getStringArray(R.array.AssamDistricts);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Assam11.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<27;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(assamDistricts[i]);
                    displayText.append("\n");
                }
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String[] listItems){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Assam11.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
