...
public class Arunachal11 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Arunachal11.class.getSimpleName();
    ...
    String[] listItems, arunachalDistricts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arunachal11);
        ...
        arunachalDistricts = getResources().getStringArray(R.array.ArunachalPradeshDistricts);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Arunachal11.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<16;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(arunachalDistricts[i]);
                    displayText.append("\n");
                }
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String[] listItems){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Arunachal11.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
