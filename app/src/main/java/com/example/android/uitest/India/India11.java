...
public class India11 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = India11.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_india11);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(India11.this);
    ...
    private List<String[]> readCVSFromAssetFolder(){
        ...
        try {
            inputStream = getAssets().open("India.csv");
