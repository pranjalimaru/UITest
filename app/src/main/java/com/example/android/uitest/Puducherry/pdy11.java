...
public class pdy11 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = pdy11.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdy11);
        ...
        ktDistricts = getResources().getStringArray(R.array.Pondicherry);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(pdy11.this);
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String[] listItems){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(pdy11.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
