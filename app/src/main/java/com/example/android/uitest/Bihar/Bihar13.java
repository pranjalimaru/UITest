...
public class Bihar13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Bihar13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=203;
    ArrayList<String> colors = new ArrayList<>();
    List<String> choice;
    Button mSelect;
    TextView mItemSelected, displayText;
    String[] listItems, biharPradesh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bihar13);
        ...
        biharPradesh= getResources().getStringArray(R.array.Bihar);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Bihar13.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<38;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(biharPradesh[i]);
                    displayText.append("\n");
                }
            }
        });
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Bihar13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
