...
public class Assam13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Assam13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=300;
    ArrayList<String> colors = new ArrayList<>();
    List<String> choice;
    Button mSelect;
    TextView mItemSelected, displayText;
    String[] listItems, assamPradesh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assam13);
        ...
        assamPradesh= getResources().getStringArray(R.array.AssamDistricts);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Assam13.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<27;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(assamPradesh[i]);
                    displayText.append("\n");
                }
            }
        });
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Assam13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
