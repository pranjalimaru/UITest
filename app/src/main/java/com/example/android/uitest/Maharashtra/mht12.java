...
public class mht12 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = mht12.class.getSimpleName();
    ...
    int bar=0, line=0, point=0, start=497;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mht12);
    ...
    private void createBarGraphSeries(List<String[]> result, int rowNo, String title){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(mht12.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
