...
public class tn13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = tn13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=602;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tn13);
        ...
        jkDistricts= getResources().getStringArray(R.array.TamilNadu);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(tn13.this);
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(tn13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
