package com.example.android.uitest.TamilNadu;
...
public class tn23 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = tn23.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tn23);
        ...
        district.add("Thiruvallur");
        district.add("Chennai");
        district.add("Kancheepuram");
        ...
        district.add("Thiruvarur");
        district.add("Thanjavur");
        district.add("Pudukkottai");
        district.add("Sivaganga");
        district.add("Madurai");
        district.add("Theni");
        district.add("Virudhunagar");
        district.add("Ramanathapuram");
        district.add("Thoothukkudi");
        district.add("Tirunelveli");
        district.add("Kanniyakumari");
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(tn23.this);
    ...
    private List<String[]> readCVSFromAssetFolder(){
        ...
        //String[] content = null;
        try {
            InputStream inputStream = getAssets().open("TamilNadu.csv");
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(tn23.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String title){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            @Override
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(tn23.this, "Series1: On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
