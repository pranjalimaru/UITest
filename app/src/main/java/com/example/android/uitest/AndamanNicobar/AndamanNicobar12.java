...
public class AndamanNicobar12 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = AndamanNicobar12.class.getSimpleName();
    ...
    String[] content, andamanDistricts;
    String StringAge=" ";
    ArrayList<Integer> SeriesToAdd = new ArrayList<>();
    int rowNo, col=0;
    int flagTotal=0, flagUrban=0, flagRural=0;
    int bar=0, line=0, point=0, start=638;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_andaman_nicobar12);
    ...
    private void createBarGraphSeries(List<String[]> result, int rowNo, String title){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(AndamanNicobar12.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
