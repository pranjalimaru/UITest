package com.example.android.uitest.Goa;
...
import com.example.android.uitest.Diu.Diu13;
...
public class Goa13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Goa13.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goa13);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Goa13.this);
        ...
        mGraph.getViewport().setMinX(582);
        mGraph.getViewport().setMaxX(589);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                displayText.setText("585: North Goa");
                displayText.append("\n");
                displayText.append("586: South Goa");
            }
        });
    ...
    private List<String[]> readCVSFromAssetFolder(){
        ...
        //String[] content = null;
        try {
            InputStream inputStream = getAssets().open("Goa.csv");
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Goa13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
