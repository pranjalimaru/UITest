...
public class utr11 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = utr11.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_utr11);
        ...
        ktDistricts = getResources().getStringArray(R.array.Uttarakhand);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(utr11.this);
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String[] listItems){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(utr11.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
