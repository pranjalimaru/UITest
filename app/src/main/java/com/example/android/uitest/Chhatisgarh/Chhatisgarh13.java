...
public class Chhatisgarh13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Chhatisgarh13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=400;
    ArrayList<String> colors = new ArrayList<>();
    List<String> choice;
    Button mSelect;
    TextView mItemSelected, displayText;
    String[] listItems, chhatisgarhPradesh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chhatisgarh13);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Chhatisgarh13.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<18;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(chhatisgarhPradesh[i]);
                    displayText.append("\n");
                }
            }
        });
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Chhatisgarh13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
