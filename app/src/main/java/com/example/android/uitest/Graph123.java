...
public class Graph123 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Graph123.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph123);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(flagUrban==1){
                    createPointGraphSeries(UrbanData,rowNo,"Urban");
                }
                if(flagRural==1){
                    createPointGraphSeries(RuralData,rowNo,"Rural");
                }
                if(flagTotal==1){
                    createPointGraphSeries(TotalData,rowNo,"Total");
                }
    ...
    private void createBarGraphSeries(List<String[]> result, int rowNo, String title){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Graph123.this, "Series1: On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
