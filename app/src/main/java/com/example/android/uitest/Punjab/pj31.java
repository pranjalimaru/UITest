...
public class pj31 extends AppCompatActivity {
    private static final String TAG = pj31.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pj31);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(pj31.this);
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(pj31.this, "On Data Point clicked: " + dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
