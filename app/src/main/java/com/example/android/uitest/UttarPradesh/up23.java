...
public class up23 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = up23.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_up23);
        ...
        district.add("Rampur");
        district.add("Jyotiba Phule Nagar");
        district.add("Meerut");
        district.add("Badhpat");
        district.add("Ghaziabad");
        district.add("Gautam Buddha Nagar");
        district.add("Bulandshahr");
        district.add("Aligarh");
        district.add("Mahamaya Nagar");
        ...
        district.add("Sant Ravidas Nagar (Bhadohi)");
        district.add("Mirzapur");
        district.add("Sonbhadra");
        district.add("Etah");
        district.add("Kanshiram Nagar");
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(up23.this);
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(up23.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String title){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            @Override
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(up23.this, "Series1: On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
