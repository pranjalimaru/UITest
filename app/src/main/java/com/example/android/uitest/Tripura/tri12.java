...
public class tri12 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = tri12.class.getSimpleName();
    ...
    int bar=0, line=0, point=0, start=289;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tri12);
    ...
    private void createBarGraphSeries(List<String[]> result, int rowNo, String title){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(tri12.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
