...
public class Delhi11 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Delhi11.class.getSimpleName();
    ...
    String[] listItems, delhiDistricts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delhi11);
        ...
        delhiDistricts = getResources().getStringArray(R.array.Delhi);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Delhi11.this);
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String[] listItems){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Delhi11.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
