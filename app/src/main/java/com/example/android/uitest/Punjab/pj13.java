...
public class pj13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = pj13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=35;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pj13);
        ...
        jkDistricts= getResources().getStringArray(R.array.Punjab);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(pj13.this);
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(pj13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
