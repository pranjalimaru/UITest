package com.example.android.uitest.WestBengal;
...
public class wb23 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = wb23.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wb23);
        ...
        district.add("Darjiling");
        district.add("Jalpaiguri");
        district.add("Koch Bihar");
        district.add("Uttar Dinajpur");
        district.add("Dakshin Dinajpur");
        district.add("Maldah");
        district.add("Murshidabad");
        district.add("Birbhum");
        district.add("Barddhaman");
        district.add("Nadia");
        district.add("North Twenty Four Parganas");
        district.add("Hugli");
        district.add("Bankura");
        district.add("Puruliya");
        district.add("Haora");
        district.add("Kolkata");
        district.add("South Twenty Four Parganas");
        district.add("Paschim Medinipur");
        district.add("Purba Medinipur");
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(wb23.this);
    ...
    private List<String[]> readCVSFromAssetFolder(){
        ...
        //String[] content = null;
        try {
            InputStream inputStream = getAssets().open("WestBengal.csv");
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(wb23.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String title){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            @Override
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(wb23.this, "Series1: On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
