...
public class Bihar11 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Bihar11.class.getSimpleName();
    ...
    String[] listItems, biharDistricts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bihar11);
        ...
        biharDistricts = getResources().getStringArray(R.array.Bihar);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Bihar11.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<38;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(biharDistricts[i]);
                    displayText.append("\n");
                }
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String[] listItems){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Bihar11.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
