...
import com.example.android.uitest.WestBengal.wb11;
import com.example.android.uitest.WestBengal.wb12;
import com.example.android.uitest.WestBengal.wb13;
import com.example.android.uitest.WestBengal.wb21;
import com.example.android.uitest.WestBengal.wb22;
import com.example.android.uitest.WestBengal.wb23;
import com.example.android.uitest.WestBengal.wb31;
import com.example.android.uitest.WestBengal.wb32;
import com.example.android.uitest.WestBengal.wb33;

public class WestBengalFront extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_west_bengal_front);
        ...
        button11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WestBengalFront.this, wb11.class);
        ...
        button12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WestBengalFront.this, wb12.class);
                startActivity(intent);
        ...
        button13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WestBengalFront.this, wb13.class);
                startActivity(intent);
        ...
        button21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WestBengalFront.this, wb21.class);
                startActivity(intent);
        ...
        button22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WestBengalFront.this, wb22.class);
                startActivity(intent);
        ...
        button23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WestBengalFront.this, wb23.class);
                startActivity(intent);
        ...
        button31.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WestBengalFront.this, wb31.class);
                startActivity(intent);
            }
        });
        ...
        button32.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WestBengalFront.this, wb32.class);
                startActivity(intent);
            }
        });
        ...
        button33.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WestBengalFront.this, wb33.class);
                startActivity(intent);
