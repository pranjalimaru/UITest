...
public class kt23 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = kt23.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kt23);
        ...
        district.add("Uttara Kannada");
        district.add("Haveri");
        district.add("Bellary");
        district.add("Chitradurga");
        district.add("Davanagere");
        district.add("Shimoga");
        district.add("Udupi");
        district.add("Chikmagalur");
        district.add("Tumkur");
        ...
        district.add("Gulbarga");
        district.add("Yadgir");
        district.add("Kolar");
        district.add("Chikkaballapura");
        district.add("Bangalore Rural");
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(kt23.this);
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(kt23.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String title){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            @Override
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(kt23.this, "Series1: On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
