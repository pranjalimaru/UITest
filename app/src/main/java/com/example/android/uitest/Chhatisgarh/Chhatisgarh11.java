...
public class Chhatisgarh11 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Chhatisgarh11.class.getSimpleName();
    ...
    String[] listItems, chhatisgarhDistricts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chhatisgarh11);
        ...
        chhatisgarhDistricts = getResources().getStringArray(R.array.Chhatisgarh);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Chhatisgarh11.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<18;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(chhatisgarhDistricts[i]);
                    displayText.append("\n");
                }
    ...
    private void createPointGraphSeries(List<String[]> result, int rowNo, String[] listItems){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Chhatisgarh11.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
