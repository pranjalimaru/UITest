package com.example.android.uitest.AndhraPradesh;
...
public class AndhraPradesh13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = AndhraPradesh13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=532;
    ArrayList<String> colors = new ArrayList<>();
    List<String> choice;
    Button mSelect;
    TextView mItemSelected, displayText;
    String[] listItems, andhraPradesh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_andhra_pradesh13);
        ...
        andhraPradesh= getResources().getStringArray(R.array.AndhraPradeshDistricts);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(AndhraPradesh13.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<24;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(andhraPradesh[i]);
                    displayText.append("\n");
                }
            }
        });
    ...
    private List<String[]> readCVSFromAssetFolder(){
        ...
        //String[] content = null;
        try {
            InputStream inputStream = getAssets().open("AndhraPradesh.csv");
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(AndhraPradesh13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
