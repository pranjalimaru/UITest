...
import com.example.android.uitest.JammuKashmir.jk11;
import com.example.android.uitest.JammuKashmir.jk12;
import com.example.android.uitest.JammuKashmir.jk13;
import com.example.android.uitest.JammuKashmir.jk21;
import com.example.android.uitest.JammuKashmir.jk22;
import com.example.android.uitest.JammuKashmir.jk23;
import com.example.android.uitest.JammuKashmir.jk31;
import com.example.android.uitest.JammuKashmir.jk32;
import com.example.android.uitest.JammuKashmir.jk33;
import com.example.android.uitest.R;

public class JammuKashmirFront extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jammu_kashmir_front);
        ...
        button11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JammuKashmirFront.this, jk11.class);
        ...
        button12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuKashmirFront.this, jk12.class);
                startActivity(intent);
        ...
        button13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuKashmirFront.this, jk13.class);
                startActivity(intent);
        ...
        button21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuKashmirFront.this, jk21.class);
                startActivity(intent);
        ...
        button22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuKashmirFront.this, jk22.class);
                startActivity(intent);
        ...
        button23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuKashmirFront.this, jk23.class);
                startActivity(intent);
        ...
        button31.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuKashmirFront.this, jk31.class);
                startActivity(intent);
            }
        });
        ...
        button32.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuKashmirFront.this, jk32.class);
                startActivity(intent);
            }
        });
        ...
        button33.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JammuKashmirFront.this, jk33.class);
                startActivity(intent);
