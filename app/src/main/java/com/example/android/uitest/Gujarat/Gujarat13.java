...
public class Gujarat13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Gujarat13.class.getSimpleName();
    ...
    int col=0, bar=0,line=0,point=0, start=468;
    ArrayList<String> colors = new ArrayList<>();
    List<String> choice;
    Button mSelect;
    TextView mItemSelected, displayText;
    String[] listItems, gujaratDistricts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gujarat13);
        ...
        gujaratDistricts= getResources().getStringArray(R.array.GujaratDistricts);
        ...
        mSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Gujarat13.this);
        ...
        loadTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0;i<26;i++) {
                    ...
                    displayText.append(": ");
                    displayText.append(gujaratDistricts[i]);
                    displayText.append("\n");
                }
            }
        });
      ...
      /* series.setValueDependentColor(new ValueDependentColor<DataPoint>() {
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Gujarat13.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
