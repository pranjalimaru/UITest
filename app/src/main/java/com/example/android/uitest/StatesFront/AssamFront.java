...
import com.example.android.uitest.Assam.Assam11;
import com.example.android.uitest.Assam.Assam12;
import com.example.android.uitest.Assam.Assam13;
import com.example.android.uitest.Assam.Assam21;
import com.example.android.uitest.Assam.Assam22;
import com.example.android.uitest.Assam.Assam23;
import com.example.android.uitest.Assam.Assam31;
import com.example.android.uitest.Assam.Assam32;
import com.example.android.uitest.Assam.Assam33;
...
public class AssamFront extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_assam_front);
        ...
        button11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AssamFront.this, Assam11.class);
        ...
        button12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AssamFront.this, Assam12.class);
                startActivity(intent);
        ...
        button13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AssamFront.this, Assam13.class);
                startActivity(intent);
        ...
        button21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AssamFront.this, Assam21.class);
                startActivity(intent);
        ...
        button22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AssamFront.this, Assam22.class);
                startActivity(intent);
        ...
        button23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AssamFront.this, Assam23.class);
                startActivity(intent);
        ...
        button31.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AssamFront.this, Assam31.class);
                startActivity(intent);
            }
        });
        ...
        button32.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AssamFront.this, Assam32.class);
                startActivity(intent);
            }
        });
        ...
        button33.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AssamFront.this, Assam33.class);
                startActivity(intent);
