...
public class Assam12 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = Assam12.class.getSimpleName();
    ...
    String[] content, assamDistricts;
    String StringAge=" ";
    ArrayList<Integer> SeriesToAdd = new ArrayList<>();
    int rowNo, col=0;
    int flagTotal=0, flagUrban=0, flagRural=0;
    int bar=0, line=0, point=0, start=300;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_assam12);
    ...
    private void createBarGraphSeries(List<String[]> result, int rowNo, String title){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(Assam12.this, "On Data Point clicked: "+ dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
